...
public class LoadExchangeNBRB
{
    public LoadExchangeNBRB() {}
    ...
    public static void main(String[] args) throws MalformedURLException, IOException {
        System.out.println(getCurrency("840")); //dollar
        System.out.println(getCurrency("643")); //rus rub
        System.out.println(getCurrency("978")); //euro
