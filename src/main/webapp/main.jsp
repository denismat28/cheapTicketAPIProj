...
<header >
    ...
    <div style="display: inline-block">
        ...
        <div style="display: inline-block">
            <form>
                <p style="display: inline-block"><select size="1" name="currency" style="height:30px;font-size:14pt;width:100px"
...
<div>
    ...
    <form:form action="/addTicketForm" method="post" modelAttribute="ticketForm">
        ...
        <form:label path="destination">Destination: </form:label> <form:input value="London" type="text"
                                                                              path="destination"/>
